...
class UCloud_Lite {
    ...
    public function __construct() {
        if(Service()->config->get('app.UCloud'))
            $this->config = array_merge($this->config, Service()->config->get('app.UCloud'));
    }
    ...
    public function upfile($fileData) {  
        ...
        $engine = 'UCloud_Engine_' . ucfirst(Service()->config->get('app.UCloudEngine'));
        ...
        if (!$res) {
            Service()->logger->debug('failed to upload file to '. $engine,
            ...
            Service()->logger->debug('succeed to upload file to '.$engine, $fileUrl);

...
return array(
    ...
    'Call to undefined method App_DI::{name}() .'               => '调用了未定义的方法App_DI::{name}()',
    ...
    'PhalApi_Api::${name} undefined'                                => 'App_Api::${name} 未定义',
    ...
    'Service()->filter should be instanceof PhalApi_Filter'              => 'Service()->filter未实现PhalApi_Filter接口',
    'wrong sign'                                                    => '签名错误',

...
return array(
    ...
    'Call to undefined method App_DI::{name}() .' => 'Call to undefined method App_DI::{name}() .',
    ...
    'PhalApi_Api::${name} undefined' => 'App_Api::${name} undefined',
	...
	'Service()->filter should be instanceof PhalApi_Filter' => 'Service()->filter should be instanceof PhalApi_Filter',

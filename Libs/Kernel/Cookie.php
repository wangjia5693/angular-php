...
```
 *  //COOKIE
 *  Service()->cookie = 'PhalApi_Cookie';
 *  
 *  //设置COOKIE服务
 *  Service()->cookie->set('name', 'phalapi', $_SERVER['REQUEST_TIME'] + 600);
 *  
 *  //获取
 *  echo Service()->cookie->get('name');  //输出 phalapi
 *  
 *  //删除
 *  Service()->cookie->delete('name');
 *
 */
